                                        ...
                                        child: SingleChildScrollView(
                                          child: Container(
                                            child: Column(
                                              ...
                                              children: [
                                                this.ventas.ventas.length == 0
                                                    ? Text(
                                                        "No hay ventas disponibles no aplicadas",
                                                        style: TextStyle(
                                                          fontWeight:
                                                              FontWeight.bold,
                                                          fontSize: 15,
                                                                          ...
                                                                          SingleChildScrollView(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  ventas.ventas[index].peso.toString() + " \Kg ",
                                                                                  textAlign: TextAlign.left,
                                                                                  style: TextStyle(
                                                                                    color: Color.fromRGBO(46, 99, 238, 1),
                                                                                    fontWeight: FontWeight.normal,
                                                                              ...
                                                                              onPressed: () {
                                                                                showDialog(
                                                                                    ...
                                                                                    builder: (context) => AlertDialog(
                                                                                          ...
                                                                                          content: Text(
                                                                                            "Desea aplicar a comprar este residuo?",
                                                                                          ),
                                                                                          actions: <Widget>[
                                                                                            TextButton(
                                                                                              child: Text(
