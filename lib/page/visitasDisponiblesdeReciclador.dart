...
class VisitaDisponiblesdeReciclador extends StatefulWidget {
  const VisitaDisponiblesdeReciclador({Key key}) : super(key: key);

  @override
  _VisitaDisponiblesdeRecicladorState createState() =>
      _VisitaDisponiblesdeRecicladorState();
}

class _VisitaDisponiblesdeRecicladorState
    extends State<VisitaDisponiblesdeReciclador> {
