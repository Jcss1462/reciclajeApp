...
class PageEditar extends StatefulWidget {
  PageEditar({Key key}) : super(key: key);
...
class _PageEditarState extends State<PageEditar> {
  ...
  Future<dynamic> getIdVenta() async {
    return await preferencias.obtenerIdVenta().then((value) async {
      idventa = value;
      return idventa;
    });
  }
  ...
  Future<Ventas> getInfoVentas() async {
    return await this.carroVentasDataSourceImpl.findByIdVentas(idventa);
  }
