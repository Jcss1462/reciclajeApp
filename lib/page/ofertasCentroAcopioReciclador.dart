...
class OfertaCentroAcopioReciclador extends StatefulWidget {
  ...
  @override
  _OfertaCentroAcopioRecicladorState createState() =>
      _OfertaCentroAcopioRecicladorState();
}

class _OfertaCentroAcopioRecicladorState
    extends State<OfertaCentroAcopioReciclador> {
                                                                                  ...
                                                                                  TextButton(
                                                                                    ...
                                                                                    onPressed: () {
                                                                                      ...
                                                                                      visitasDatasourceImpl.agendar(agenda).then((value) {
                                                                                        ...
                                                                                        showDialog(
                                                                                          context: context,
                                                                                          builder: (context) => DialogBox("Error al Reservar", error.toString()),
                                                                                        );
                                                                                      });
                                                                                    },
                                                                                  ),
